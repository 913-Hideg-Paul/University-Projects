...
void testRemove() {
	...
	for (int i = -200; i < 100; i++) { 
		if (i < -100 || i >= 100 ) {
			...
			if (i == -1)
			{
				cout << "0.nr occurences of -1 after removal index " << i << " =" << b.nrOccurrences(-1) << endl;
			}
			cout << "0.nr occurences of 0 after removal index " << i << " =" << b.nrOccurrences(0) << endl;
			assert(b.remove(i) == true);
			if (i == -1)
			{
				cout << "1.nr occurences of -1 after removal index " << i << " =" << b.nrOccurrences(-1) << endl;
			}
			cout << "1.nr occurences of 0 after removal index " << i << " =" << b.nrOccurrences(0) << endl;
			assert(b.remove(i) == true);
			if (i == -1)
			{
				cout << "2.nr occurences of -1 after removal index " << i << " =" << b.nrOccurrences(-1) << endl;
			}
			cout << "2.nr occurences of 0 after removal index " << i << " =" << b.nrOccurrences(0) << endl;
			assert(b.remove(i) == true);
			if (i == -1)
			{
				cout << "3.nr occurences of -1 after removal index " << i << " =" << b.nrOccurrences(-1) << endl;
				cout << "3.nr occurences of 0 after removal index " << i << " =" << b.nrOccurrences(0) << endl;
				assert(b.remove(i) == true);
			}
			else
			{
			...
			cout << "4.nr occurences of -1 after removal index " << i << " =" << b.nrOccurrences(-1) << endl;
			cout << "4.nr occurences of 0 after removal index " << i << " =" << b.nrOccurrences(0) << endl;
			assert(b.remove(i) == false);
			if (i == -1)
			{
				cout << "5.nr occurences of -1 after removal index " << i << " =" << b.nrOccurrences(-1) << endl;
			}
			cout << "5.nr occurences of 0 after removal index " << i << " =" << b.nrOccurrences(0) << endl;
		}
	}
